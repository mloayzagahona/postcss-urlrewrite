...
var urlrewrite = function( config ) {
    ...
    var updateDecl = function( decl ) {
        ...
        // for some reason this helper is getting an array with undefined element
        // we have to remove it from the evaluation
        if (helper.URIS && helper.URIS.length == 1 && typeof helper.URIS[0] === 'undefined'){
          return;
        }
